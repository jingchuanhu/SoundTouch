...
extern "C" DLL_PUBLIC jlong Java_com_jch_soundtouchlib_SoundTouch_newInstance(JNIEnv *env,
                                                                              jclass thiz)
{
...
extern "C" DLL_PUBLIC void Java_com_jch_soundtouchlib_SoundTouch_deleteInstance(JNIEnv *env, jobject thiz, jlong handle)
{
...
extern "C" DLL_PUBLIC void Java_com_jch_soundtouchlib_SoundTouch_setTempo(JNIEnv *env, jobject thiz, jlong handle, jfloat tempo)
{
	SoundTouch *ptr = (SoundTouch*)handle;
	ptr->setTempo(tempo);
}
...
extern "C" DLL_PUBLIC void Java_com_jch_soundtouchlib_SoundTouch_setPitchSemiTones(JNIEnv *env, jobject thiz, jlong handle, jfloat pitch)
{
	SoundTouch *ptr = (SoundTouch*)handle;
...
extern "C" DLL_PUBLIC void Java_com_jch_soundtouchlib_SoundTouch_setSpeed(JNIEnv *env, jobject thiz, jlong handle, jfloat speed)
{
	SoundTouch *ptr = (SoundTouch*)handle;
	ptr->setRate(speed);
}
...
extern "C" DLL_PUBLIC jstring Java_com_jch_soundtouchlib_SoundTouch_getErrorString(JNIEnv *env,
                                                                                   jclass thiz)
{
...
extern "C" DLL_PUBLIC int Java_com_jch_soundtouchlib_SoundTouch_processFile(JNIEnv *env, jobject thiz, jlong handle, jstring jinputFile, jstring joutputFile)
{
	SoundTouch *ptr = (SoundTouch*)handle;
